<script type="text/javascript">
  ...
  {
    alertify.alert("Info", "Votre ID admin est "+ admin_id+"", function() {
      alertify.success("Ok");
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-center mb-5">
              <div clas="row">
                <img src="assets/images/orebank.png" alt="logo" height="24">
              </div>
                ...
                <div class="card-body p-4">
                  <div class="p-2">
                    <h5 class="mb-5 text-center">
                      S'enregistrer dans OREBANK Central
                    </h5>
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="form-group mb-4">
                            ...
                            <input
                              ...
                              class="form-control"
                              name="txt_mobile"
                                placeholder="Entre votre numéro mobile"
                              required
                            />
                          </div>
                          <div class="form-group mb-4">
                          ...
                          <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label font-weight-normal" for="term-conditionCheck">J'accepte les <a href="#" class="text-primary">Termes et Conditions</a></label>
                          </div>
