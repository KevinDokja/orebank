<?php
    ...
    if(isset($_SESSION["s_admin_id"]))
    {
        ...
        //Number of Logins
        $query_for_no_of_logins = "SELECT * FROM tbl_login_history";
        $result_no_of_login = mysqli_query($con,$query_for_no_of_logins);
        $no_of_login = mysqli_num_rows($result_no_of_login); 
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Historique de connexion des clients</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item">Admin</li>
                                            <li class="breadcrumb-item active">Historique de connection</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">Nombre de connexion</h5>
                                            </div>
                                            <div class="avatar-xs">
                                        ...
                                        <h4 class="m-0 align-self-center"><?php echo $no_of_login ?></h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-4">Historique de connexion/déconnexion des clients</h4>
                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Date & Heure de déconnexion</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($customers_details)) {
                                                        ...
                                                        $query_for_full_name = "SELECT full_name FROM tbl_customer WHERE    account_no=$Account_no";
                                                        $result_of_full_name = mysqli_query($con, $query_for_full_name);
                                                        $full_name = mysqli_fetch_array($result_of_full_name)[0];
                                                       echo 
                                                       '<tr>
                                                            <td>
                                                                <div class="avatar-xs">
                                                            ...
                                                            <td>
                                                                ...
                                                                <h5 class="font-size-15 mb-0">'.$full_name.' </h5>
                                                            </td>
                                                            <td>'.$row["login_time"].'</td>
                                                            <td>'.$row["logout_time"].'<br></td>
                                                    </tr>';
                                                   } 
                                                ?>    
                                                </tbody>
