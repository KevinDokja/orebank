                                        ...
                                        <ul class="nav nav-tabs nav-justified nav-tabs-custom" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#custom-primary" role="tab">
                                                    <i class="mdi mdi-inbox mr-2 align-middle font-size-18"></i> <span class="d-none d-md-inline-block">Demandes approuvées</span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#custom-social" role="tab">
                                                    <i class="mdi mdi-account-group-outline mr-2 align-middle font-size-18"></i> <span class="d-none d-md-inline-block"> Demandes ignorées</span>
                                                </a>
                                            </li>
                                                ...
                                                <ul class="message-list mb-0">
                                                    ...
                                                    while($row = mysqli_fetch_array($request_result)) {
                                                        ...
                                                        <div class="col-mail col-mail-2">
                                                            <a href="view_request_read.php?request_id='.$row['request_id'].'" class="subject"><span class="'.$badge_color.' badge mr-2">MGA '.$row['amount'].'</span>'.$row["message"].'
                                                            </a>
                                                ...
                                                <ul class="message-list mb-0">
                                                    ...
                                                    while($row = mysqli_fetch_array($request_result)) {
                                                        ...
                                                        <div class="col-mail col-mail-1">
                                                            ...
                                                            <a href="view_request_read.php?request_id='.$row['request_id'].'" class="title">'.$first_sender_name.' à '.$first_reciver_name.'</a>
                                                        </div>
                                                        <div class="col-mail col-mail-2">
                                                            <a href="view_request_read.php?request_id='.$row['request_id'].'" class="subject"><span class="'.$badge_color.' badge mr-2">MGA '.$row['amount'].'</span>'.$row["message"].'
                                                            </a>
