                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Profile du client</h4>
                                      
                                        
                                        <form class="needs-validation" novalidate method="post">
                                        <div class="row col-md-6 mb-3 mt-3">
                                            <h5>Numéro de compte : <?php echo $Account_no; ?></h5>
                                        </div>
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                <label for="validationTooltip01">Nom</label>
                                                <input type="text" name="txt_fname" class="form-control" id="validationTooltip01" placeholder="First name" value="<?php echo $first_name?>" disabled required>
                                                ...
                                                <input type="text" name="txt_lname" class="form-control" id="validationTooltip02" placeholder="Last name" value="<?php echo $last_name ?>" disabled required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="txt_mobile" class="form-control" id="validationTooltip01" placeholder="Mobile" value="<?php echo $row_customer['mobile']?>" disabled required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                </div>
                                                ...
                                                <input type="text" name="txt_email" class="form-control" id="validationTooltip02" placeholder="Email Id" value="<?php echo $row_customer['email']?>" disabled required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="txt_address" class="form-control" id="validationTooltip03" placeholder="Address" value="<?php echo $row_address['home_address']?>" disabled required>
                                                ...
                                                <input type="text" name="txt_city" class="form-control" id="validationTooltip03" placeholder="City" value="<?php echo $row_address['city']?>" disabled required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid city.
                                                </div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                <label for="validationTooltip04">Etat</label>
                                                <input type="text" name="txt_state" class="form-control" id="validationTooltip04" placeholder="State" value="<?php echo $row_address['state']?>"disabled required>
                                                <div class="invalid-feedback">
                                                ...
                                                <input type="text" name="txt_zip" class="form-control" id="validationTooltip04" placeholder="Zip" value="<?php echo $row_address['pincode']?>" disabled required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid state.
                                                </div>
                                                </div>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                  <label>Nom utilisateur</label>
                                                    <input type="text" name="txt_username" class="form-control" value="<?php echo $acc_username?>" required disabled
                                                            placeholder="Password"/>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                  <label>Mot de passe</label>
                                                    <input type="text" name="txt_password" id="pass2" class="form-control" value="<?php echo $acc_password?>" required disabled
                                                            placeholder="Password"/>
                                                </div>
                                                <!-- <div class="col-md-4 mb-3">
