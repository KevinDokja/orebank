        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-center mb-5">
              ...
              <h5 class="font-size-25 text-white mb-4">Uniquement pour Admin</h5>
              ...
              <div class="card-body p-4">
                <div class="p-2">
                  <h5 class="mb-5 text-center">
                    Authentifiez-vous pour continuer dans OREBANK.
                  </h5>
                      ...
                      <div class="col-md-12">
                        <div class="form-group mb-4">
                          ...
                          <input
                            ...
                            id="adminId"
                            name='txt_adminid'
                            placeholder="Entrer votre ID admin"
                            value=""
                            required
                        ...
                        <div class="mt-4 text-center">
                          <a href="auth-register.php" class="text-muted"
                            ><i class="mdi mdi-account-circle mr-1"></i> S'enregistrer</a
                          >
                        </div>
                      </div>
                    </div>
