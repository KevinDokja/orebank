<script type="text/javascript">
  ...
  function accountSame()
  {
    Swal.fire({
      ...
      text: "Vous ne pouvez pas envoyer de demande à vous-même !",
      icon: "error"
    });
  }
  ...
  function wrongAccount()
  {
    Swal.fire({
      title: "Demande non envoyée",
      text: "Numéro de compte invalide",
      icon: "error"
    });
  }
  ...
  function amountLimit()
  {
    Swal.fire({
      title: "Demande non envoyée",
      text: "Le montant de la demande doit être entre 500 et 1,000,000 MGA",
      icon: "error"
    });
  }
</script>
                                ...
                                <div class="card h-100">
                                    <div class="card-body email-leftbar">
                                        ...
                                        <div class="mail-list mt-4">
                                            ...
                                            <a href="send_requests.php"><i class="mdi mdi-send-check-outline mr-2"></i>Demandes envoyées</a>
                                    ...
                                    <div class="card-body">
                                        <form class="custom-validation" action="#" method="post">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input name="txt_to_account" data-parsley-type="digits" type="text" class="form-control" required placeholder="Numéro de compte"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Montant</label>
                                                <div>
                                                    <input name="txt_amount" data-parsley-type="digits" type="text" class="form-control" required placeholder="Montant"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="subject-input">Message</label>
                                                <div>
                                                    <textarea name="txt_message" class="form-control" rows="5" required>Pourriez-vous envoyer de l'argent à ce compte, s'il vous plaît ?</textarea>
                                                </div>
                                            </div>
    
                                            <div class="btn-toolbar form-group mb-0">
                                                <div class="">
                                                    <button name="btn_send" type="submit" class="btn btn-primary waves-effect waves-light"> <span>Envoyer</span> <i class="fab fa-telegram-plane ml-1"></i> </button>
                                                </div>
                                            </div>
...
<?php
    ...
    if(isset($_REQUEST['btn_send']))
    {
        ...
        $message = addslashes($_REQUEST['txt_message']);
        $hasViewed = 0;
        $status = 'ignore';
        ...
        elseif($amount > 1000000 || $amount < 500)
        {
            echo '<script type="text/JavaScript">  
              amountLimit();
             </script>' 
