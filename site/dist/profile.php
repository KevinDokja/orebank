                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Votre profile</h4>
                                        ...
                                        <div class="row col-md-6 mb-3 mt-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="txt_fname" class="form-control" id="validationTooltip01" placeholder="Nom" value="<?php echo $first_name?>" required>
                                                ...
                                                <input type="text" name="txt_lname" class="form-control" id="validationTooltip02" placeholder="Prénoms" value="<?php echo $last_name ?>" required>
                                                <div class="valid-feedback">
                                                    Parfait!
                                                </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="txt_mobile" class="form-control" id="validationTooltip01" placeholder="Numéro de téléphone" value="<?php echo $row_customer['mobile']?>" required>
                                                <div class="valid-feedback">
                                                    Parfait!
                                                </div>
                                                </div>
                                                ...
                                                <input type="text" name="txt_email" class="form-control" id="validationTooltip02" placeholder="Adresse e-mail" value="<?php echo $row_customer['email']?>" required>
                                                <div class="valid-feedback">
                                                    Parfait!
                                                </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="txt_address" class="form-control" id="validationTooltip03" placeholder="Addresse" value="<?php echo $row_address['home_address']?>" required>
                                            ...
                                            <button class="btn btn-primary" name="btn_update" type="submit">Modifier</button>
