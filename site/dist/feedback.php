                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Avis</h4>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <textarea name="txt_feedback" id="textarea" class="form-control" maxlength="225" rows="5" placeholder="Exprimez-vous en moins de 255 caractères." required></textarea>
                                            </div>

                                            <div class="btn-toolbar justify-content-md-end" role="toolbar">
                                            <div class="col-xl-3 col-md-4 col-sm-6">
                                                <div class="p-4 text-center">
                                                    <h5 class="font-size-15 mb-3">Note</h5>
                                            ...
                                            <div class="btn-toolbar justify-content-md-end" role="toolbar">
                                                <div class="btn-toolbar form-group mb-0 mr-3">
                                                    <div class="">
                                                        ...
                                                        <button name="btn_submit" class="btn btn-primary waves-effect waves-light"> <span>Envoyer</span> <i class="fab fa-telegram-plane ml-1"></i> </button>
                                                    </div>
                                                </div>
                                            </div>
...
<?php
    ...
    {
        $text_feedback =addslashes($_REQUEST['txt_feedback']);
