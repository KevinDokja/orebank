<script type="text/javascript">
  function sweetAlertSuccess()
  {
    Swal.fire({
      position: "top-end",
      icon: "success",
      title: "Montant transferer avec succès",
      showConfirmButton: !1,
      timer: 1500
    });
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Boîte de réception</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>   
                                ...
                                <div class="card h-100">
                                    <div class="card-body email-leftbar">
                                        ...
                                        <div class="mail-list mt-4">
                                            ...
                                            ?>
                                            <a href="inbox.php" class="active"><i class="mdi mdi-inbox mr-2"></i>Boîte de réception  <span class="ml-1 float-right">(<?php echo $no_of_requests; ?>)</span></a>
                                    ...
                                    <div class="card-body">
                                        <div class="media mb-4">
                                            ...
                                            <div class="btn-group ml-md-2 mb-3">
                                                <?php
                                                    if($row_request['status'] != 'sent')
                                                    {
                                                        $amount = $row_request['amount'];
                                                        $status = "<span class='badge-danger badge mr-3'>Demande de ".$amount."</span>";
                                                    }
                                                    else
                                                    {
                                                        $amount = $row_request['amount'];
                                                        $status = "<span class='badge-success badge mr-3'>Vous avez envoyé ".$amount."</span>";
                                                    }
                                                    echo $status;
                                                ?>
                                        ...
                                        <p>Chèr(e) <?php echo $row_customer['full_name'];?>,</p>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="btn-toolbar justify-content-md-end" role="toolbar">
                                            <div class="btn-group ml-md-2 mb-3">
                                                <!-- Check Status if it is sent then do not Show this button -->
                                                <?php 
                                                    if($row_request['status'] != 'sent')
                                                    {
                                                        $amount = $row_request["amount"];
                                                        $send_button = 
                                                        '<form method="post"> 
                                                        <input type="submit" class="btn btn-primary waves-effect waves-light mt-2 mr-3" name="btn_send_money" value="Envoyer MGA '.$amount.'"/>
                                                    </form>';
                                                    }
                                                    else
                                                    {
    ...
    if(isset($_REQUEST['btn_send_money']))
    {
        ...
        else
        {
            ...
            else
            {
              ...
              echo "ERROR: Impossible d'executer $query. " . mysqli_error($con);
            }
        }
    }
?>