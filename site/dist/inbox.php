                                        ...
                                        <ul class="nav nav-tabs nav-justified nav-tabs-custom" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#custom-primary" role="tab">
                                                    <i class="mdi mdi-inbox mr-2 align-middle font-size-18"></i> <span class="d-none d-md-inline-block">Boîte de réception</span> 
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content pt-3">
                                            <div class="tab-pane active" id="custom-primary" role="tabpanel">
                                                ...
                                                <?php
                                                    ...
                                                    $query_for_request = "SELECT * FROM tbl_requests where to_account = $Account_no ORDER BY request_date DESC ";
                                                    ...
                                                    while($row = mysqli_fetch_array($request_result)) {
                                                        ...
                                                        <div class="col-mail col-mail-2">
                                                            <a href="inbox_read.php?request_id='.$row['request_id'].'" class="subject"><span class="'.$badge_color.' badge mr-2">MGA '.$row['amount'].'</span>'.$row["message"].'
                                                            </a>
